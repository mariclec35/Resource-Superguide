...
export default function Mission() {
  useEffect(() => {
    document.title = "Our Mission | MN Recovery Hub";
    window.scrollTo(0, 0);
  }, []);
  ...
  const sections = [
    ...
    { id: 'minnesota-focus', title: 'Minnesota Focus' },
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-800 font-sans selection:bg-emerald-200 selection:text-emerald-900">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-2xl md:text-3xl font-medium text-emerald-900/80 leading-snug max-w-3xl mx-auto mb-12">
              Making recovery resources easier to find, easier to trust, and easier to use for people in Minneapolis, Saint Paul, and surrounding Minnesota communities.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="flex flex-col">
            ...
            <FadeIn>
              <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start">
                ...
                <div className="md:w-2/3 prose prose-lg prose-zinc text-zinc-600 leading-relaxed">
                  ...
                  <p>When meetings, programs, and services are difficult to locate, people can lose time, feel overwhelmed, or miss support during important moments. MN Recovery Hub was created to reduce that friction by making recovery information easier to access and easier to understand.</p>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <FadeIn>
              <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start">
                ...
                <div className="md:w-2/3 prose prose-lg prose-zinc text-zinc-600 leading-relaxed">
                  <p>MN Recovery Hub is being built as a central place for recovery-related information in Minnesota.</p>
                  ...
                  <ul className="space-y-4 my-8 list-none pl-0">
                    ...
                    <li className="flex items-start gap-4">
                      <div className="mt-2.5 w-1.5 h-1.5 rounded-full bg-emerald-400 shrink-0"></div>
                      <span>Creating a more connected recovery ecosystem across Minnesota</span>
                    </li>
                  </ul>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <FadeIn>
              <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start">
                ...
                <div className="md:w-2/3 prose prose-lg prose-zinc text-zinc-600 leading-relaxed">
                  <p>MN Recovery Hub is designed to support:</p>
                  <ul className="space-y-4 my-8 list-none pl-0">
                    <li className="flex items-start gap-4">
                      <div className="mt-2.5 w-1.5 h-1.5 rounded-full bg-emerald-400 shrink-0"></div>
        ...
        {/* Minnesota Focus */}
        <section id="minnesota-focus" className="scroll-mt-16 py-16 md:py-24 bg-emerald-50/30">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <FadeIn>
              <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start">
                <div className="md:w-1/3 shrink-0">
                  <h2 className="text-3xl md:text-4xl font-bold text-zinc-900 tracking-tight">Minnesota Focus</h2>
                </div>
                <div className="md:w-2/3 prose prose-lg prose-zinc text-zinc-600 leading-relaxed">
                  <p>This platform is built specifically for the recovery community in Minneapolis, Saint Paul, and across Minnesota.</p>
                  <p>Minnesota has a strong recovery community made up of people, organizations, and programs working every day to support others. MN Recovery Hub is meant to strengthen those connections by making local support easier to find and easier to share.</p>
                  <blockquote className="border-l-2 border-emerald-500 pl-6 my-8 italic text-zinc-800 font-medium text-xl md:text-2xl leading-snug">
                    "This is a statewide platform with a local purpose: helping people in these communities connect to the help that already exists here."
                  </blockquote>
                </div>
              </div>
            </FadeIn>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <FadeIn>
              <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start">
                ...
                <div className="md:w-2/3 prose prose-lg prose-zinc text-zinc-600 leading-relaxed">
                  <p>MN Recovery Hub is built with one priority in mind: supporting the recovery community.</p>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <FadeIn>
              <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start">
                ...
                <div className="md:w-2/3 prose prose-lg prose-zinc text-zinc-600 leading-relaxed">
                  <p>MN Recovery Hub is also designed to support the organizations, programs, and groups that serve the recovery community.</p>
                  ...
                  <blockquote className="border-l-2 border-emerald-500 pl-6 my-8 italic text-zinc-800 font-medium text-xl md:text-2xl leading-snug">
                    "The long-term goal is to strengthen the overall recovery ecosystem by improving visibility, connection, and access across Minnesota."
                  </blockquote>
                </div>
              </div>
            </FadeIn>
      ...
      <section className="bg-white py-16 md:py-24 px-4 border-t border-zinc-100">
        <div className="max-w-4xl mx-auto text-center">
          <FadeIn>
            <h3 className="text-2xl md:text-3xl font-bold mb-4 tracking-tight text-zinc-900">MN Recovery Hub</h3>
